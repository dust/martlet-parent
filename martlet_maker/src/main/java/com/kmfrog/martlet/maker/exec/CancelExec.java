...
public class CancelExec extends Exec {
    ...
    public CancelExec(Instrument instrument, Set<Long> orderIds, boolean isOpenOnly, TrackBook trackBook,
            DepthService depthService, String api, String secret, Logger logger) {
