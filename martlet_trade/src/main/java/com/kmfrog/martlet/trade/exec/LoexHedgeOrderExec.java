...
public class LoexHedgeOrderExec extends Exec{
	
	static Logger logger = LoggerFactory.getLogger(LoexHedgeOrderExec.class);
    ...
    public LoexHedgeOrderExec(Source src, Instrument instrument, long price, long spread, long vMin, long vMax,
            int avgSleep, LoexApiRestClient client, TrackBook trackBook, Provider provider) {
